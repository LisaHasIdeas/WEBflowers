    ...
    public partial class _Default : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                myCookieobj = new HttpCookie("MyCookie2"); myCookieobj.Value = "280"; Response.Cookies.Add(myCookieobj);
                ...
                myCookieobj = new HttpCookie("MyCookieTrans3"); myCookieobj.Value = "90"; Response.Cookies.Add(myCookieobj);
                c3 = Color.FromArgb(90, 100, 100, 205);
            ...
            if (IsPostBack)
            {
                ...
                Image1.ImageUrl = "~/MyImages/dog.jpg";
            }
        ...
        private void DoMainWork()
        {
            ...
            c1 = Color.FromArgb(tempTrans1, tempRed1, tempGreen1, tempBlue1);
            c2 = Color.FromArgb(tempTrans2, tempRed2, tempGreen2, tempBlue2);
            c3 = Color.FromArgb(tempTrans3, tempRed3, tempGreen3, tempBlue3);
            ...
            using (MemoryStream ms = new MemoryStream())
            {
                ...
                using (Graphics g = Graphics.FromImage(bitmapImage))
                {
                    ...
                    System.Drawing.Brush br1 = new SolidBrush(c1);
                    Brush br2 = new SolidBrush(c2);
                    Brush br3 = new SolidBrush(c3);
